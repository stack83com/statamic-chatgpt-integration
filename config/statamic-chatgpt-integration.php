...
return [
    ...
    'instructions' => env('OPENAI_INITIAL_INSTRUCTIONS', 'You are Statamic AI, a helpful assistant the will primarily be used to help writing content for web like blog and news articles. ' .
